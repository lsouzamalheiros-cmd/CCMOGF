...
st.set_page_config(page_title="Sistema Escolar - CCMOGF by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:on1OnXMA74SjFMWc@cluster0.zogaia0.mongodb.net/"
...
👨‍🏫 Escola [CCM Osmar Guaracy Freire]
📞 Contato: [43 34247-6562]
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR OSMAR GUARACY FREIRE</b>",
        cabecalho_style
    ))
